...
GLOBAL_CV2 = `python3 -c 'import cv2; print(cv2)' | awk '{print $$4}' | sed s:"['>]":"":g`
...
track: venv
	test -d venv || virtualenv -p python3 venv
	. venv/bin/activate && python3 FlyTracking.0.01.py -i /media/neberle/6CEC5E62EC5E271C/Backup_Linux/fly_tracker/dataset/fly_tracker_1280_960_3.h264
